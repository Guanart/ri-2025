...
def main():
    ...
    ir.index_collection(dir_root='../datos/en/articles')
    ...
    results_tfidf = ir.retrieve(topics, model="TF_IDF") # DataFrame con columnas [qid, docno, score, rank]
    ...
    results = []
    for qid in topics.qid:
        # Se calculan correlaciones únicamente con docno (o docid) para simplificar
        for k in (10,25,50):
    ...
    print("Si es cercano a 0 (o negativo), hay diferencias más marcadas entre los modelos.")
