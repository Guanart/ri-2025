...
def test_preserve_query():
    ...
    print(f"URLs con query params (preserve_query=False): {len(urls_with_params_no_query)}")
    print(f"URLs con query params (preserve_query=True): {len(urls_with_params_with_query)}")
    ...
    print(f"Páginas dinámicas (preserve_query=True): {stats_with_query.get('dynamic_pages', 0)}")
    
    print(f"\nPáginas estáticas (preserve_query=False): {stats_no_query.get('static_pages', 0)}")
    print(f"Páginas estáticas (preserve_query=True): {stats_with_query.get('static_pages', 0)}")
